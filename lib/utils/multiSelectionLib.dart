...
class GFMultiSelect<T> extends StatefulWidget {
  ...
  const GFMultiSelect({
    ...
    this.dropdownUnderlineBorder = const BorderSide(color: Colors.black45, width: 1),
      ...
      children: [
        InkWell(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(color: widget.dropdownTitleTileColor, border: widget.dropdownTitleTileBorder, borderRadius: widget.dropdownTitleTileBorderRadius),
                child: Container(
                  decoration: BoxDecoration(
                    border: widget.hideDropdownUnderline ? const Border(bottom: BorderSide(color: Colors.transparent)) : Border(bottom: widget.dropdownUnderlineBorder),
                  ),
                          ...
                          Row(
                            ...
                            children: [
                              GFButton(
                                ...
                                borderShape: RoundedRectangleBorder(side: BorderSide(color: Colors.grey)),
                                onPressed: () {
                                  setState(() {
                                    showDropdown = !showDropdown;
                                ...
                                child: widget.cancelButton ?? const Text('CANCEL'),
                              ),
                              SizedBox(width: 16),
                              GFButton(
                                color: colorPrimary,
